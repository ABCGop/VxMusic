...
import com.abcg.music.expect.ui.PlatformWebView
import com.abcg.music.expect.ui.createWebViewCookieManager
import com.abcg.music.expect.ui.rememberWebViewState
import com.abcg.music.ui.component.DevLogInBottomSheet
import com.abcg.music.ui.component.DevLogInType
...
import vxmusic.composeapp.generated.resources.log_in
import vxmusic.composeapp.generated.resources.login_failed
import vxmusic.composeapp.generated.resources.login_success
    ...
    LaunchedEffect(state) {
        snapshotFlow { state.value }.collect {
            Logger.d(
                ...
                "WebViewState: ${
                    when (it) {
                        is com.abcg.music.expect.ui.WebViewState.Finished -> "Finished"
                        is com.abcg.music.expect.ui.WebViewState.Loading -> "Loading ${it.progress}%"
                    }
                }",
            )
        }
