...
kotlin {
    ...
    android {
        namespace = "com.abcg.music.composeapp"
        compileSdk = 37
        minSdk = 26
        withJava()
        androidResources {
...
compose.desktop {
    application {
        mainClass = "com.abcg.music.MainKt"
                ...
                val macExtraPlistKeys =
                    ...
                    <array>
                        <dict>
                            ...
                            <string>com.abcg.music.deeplink</string>
...
afterEvaluate {
    ...
    fun packAppImage(isRelease: Boolean) {
        ...
        val versionName =
            libs.versions.version.name
                .get()
        val desktopFile = appDir.resolve("vxmusic.desktop")
        desktopFile.writeText(
            """[Desktop Entry]
            |Type=Application
            |Version=1.0
            |Name=VxMusic
            |Comment=VxMusic v$versionName - FOSS YouTube Music Client
            |Exec=bin/VxMusic %u
            |Icon=vxmusic
            |Terminal=false
            |Categories=Audio;AudioVideo;
            |StartupWMClass=com-abcg-music-MainKt
            |MimeType=x-scheme-handler/vxmusic;
            |
            """.trimMargin(),
        )
        ...
        appRun.writeText(
            ...
            |if [ ! -f "${'$'}ICON_DIR/vxmusic.png" ] || [ "${'$'}HERE/vxmusic.png" -nt "${'$'}ICON_DIR/vxmusic.png" ]; then
            |    mkdir -p "${'$'}ICON_DIR"
            |    cp "${'$'}HERE/vxmusic.png" "${'$'}ICON_DIR/vxmusic.png"
            ...
            |sed "s|Exec=bin/VxMusic|Exec=${'$'}APPIMAGE_PATH|" "${'$'}HERE/vxmusic.desktop" > "${'$'}DESKTOP_DIR/com-abcg-music-MainKt.desktop"
