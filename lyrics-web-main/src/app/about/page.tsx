...
import { Github, Mail, Rocket, Terminal } from 'lucide-react';

export default function Developer() {
  return (
    <div className="flex-1 flex flex-col items-center justify-start min-h-screen relative overflow-x-hidden pt-24">
