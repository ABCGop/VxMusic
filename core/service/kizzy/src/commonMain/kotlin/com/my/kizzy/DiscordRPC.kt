...
class DiscordRPC(
    ...
    suspend fun updateSong(
        ...
        setActivity(
            ...
            buttons =
                listOf(
                    "Listen on VxMusic" to "https://simpmusic.org/app/watch?v=${song.videoId}",
                    "Visit VxMusic" to "https://github.com/maxrave-dev/SimpMusic",
                ),
            type = Type.LISTENING,
            since = currentTime,
    ...
    companion object {
        ...
        private const val APP_NAME: String = "VxMusic"
