...
import com.abcg.kotlinytmusicscraper.encoder.brotli
...
import com.abcg.kotlinytmusicscraper.models.YouTubeClient.Companion.ANDROID_MUSIC
import com.abcg.kotlinytmusicscraper.models.YouTubeClient.Companion.IOS
...
import com.abcg.kotlinytmusicscraper.models.body.AccountMenuBody
import com.abcg.kotlinytmusicscraper.models.body.BrowseBody
import com.abcg.kotlinytmusicscraper.models.body.CreatePlaylistBody
import com.abcg.kotlinytmusicscraper.models.body.EditPlaylistBody
import com.abcg.kotlinytmusicscraper.models.body.FormData
import com.abcg.kotlinytmusicscraper.models.body.GetQueueBody
import com.abcg.kotlinytmusicscraper.models.body.GetSearchSuggestionsBody
import com.abcg.kotlinytmusicscraper.models.body.LikeBody
import com.abcg.kotlinytmusicscraper.models.body.NextBody
import com.abcg.kotlinytmusicscraper.models.body.PlayerBody
import com.abcg.kotlinytmusicscraper.models.body.SearchBody
import com.abcg.kotlinytmusicscraper.utils.CurlLogger
import com.abcg.kotlinytmusicscraper.utils.KtorToCurl
import com.abcg.kotlinytmusicscraper.utils.parseCookieString
import com.abcg.kotlinytmusicscraper.utils.sha1
...
//    }
    ...
    suspend fun checkForGithubReleaseUpdate() =
        httpClient.get("https://api.github.com/repos/ABCGop/VxMusic/releases/latest") {
            contentType(ContentType.Application.Json)
        }
