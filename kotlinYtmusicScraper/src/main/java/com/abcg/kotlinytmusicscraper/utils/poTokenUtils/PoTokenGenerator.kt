package com.abcg.kotlinytmusicscraper.utils.poTokenUtils
...
import com.abcg.kotlinytmusicscraper.utils.poTokenUtils.JavaScriptUtil.buildExceptionForJsError
import com.abcg.kotlinytmusicscraper.utils.poTokenUtils.JavaScriptUtil.parseChallengeData
import com.abcg.kotlinytmusicscraper.utils.poTokenUtils.JavaScriptUtil.parseIntegrityTokenData
import com.abcg.kotlinytmusicscraper.utils.poTokenUtils.JavaScriptUtil.stringToU8
import com.abcg.kotlinytmusicscraper.utils.poTokenUtils.JavaScriptUtil.u8ToBase64
...
class PoTokenWebView(
            ...
            object : android.webkit.WebChromeClient() {
                override fun onConsoleMessage(m: ConsoleMessage): Boolean {
                    if (m.message().contains("Uncaught")) {
                        ...
                        val exception =
                            _root_ide_package_.com.abcg.kotlinytmusicscraper.utils.poTokenUtils
    ...
    private suspend fun makeBotguardServiceRequest(
        ...
        withContext(Dispatchers.IO) {
            ...
            if (httpCode != 200) {
                throw _root_ide_package_.com.abcg.kotlinytmusicscraper.utils.poTokenUtils
