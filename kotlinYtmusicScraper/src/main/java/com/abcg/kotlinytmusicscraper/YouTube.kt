package com.abcg.kotlinytmusicscraper
...
import com.abcg.kotlinytmusicscraper.YouTube.Companion.DEFAULT_VISITOR_DATA
import com.abcg.kotlinytmusicscraper.extension.toListFormat
import com.abcg.kotlinytmusicscraper.models.AccountInfo
...
import com.abcg.kotlinytmusicscraper.models.BrowseEndpoint
import com.abcg.kotlinytmusicscraper.models.GridRenderer
import com.abcg.kotlinytmusicscraper.models.MediaType
import com.abcg.kotlinytmusicscraper.models.MusicCarouselShelfRenderer
...
import com.abcg.kotlinytmusicscraper.models.PoToken
import com.abcg.kotlinytmusicscraper.models.ReturnYouTubeDislikeResponse
import com.abcg.kotlinytmusicscraper.models.Run
import com.abcg.kotlinytmusicscraper.models.SearchSuggestions
import com.abcg.kotlinytmusicscraper.models.SongInfo
import com.abcg.kotlinytmusicscraper.models.SongItem
import com.abcg.kotlinytmusicscraper.models.VideoItem
import com.abcg.kotlinytmusicscraper.models.WatchEndpoint
import com.abcg.kotlinytmusicscraper.models.YTItemType
import com.abcg.kotlinytmusicscraper.models.YouTubeClient
import com.abcg.kotlinytmusicscraper.models.YouTubeClient.Companion.TVHTML5
import com.abcg.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB
import com.abcg.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB_REMIX
import com.abcg.kotlinytmusicscraper.models.YouTubeLocale
import com.abcg.kotlinytmusicscraper.models.getContinuation
import com.abcg.kotlinytmusicscraper.models.oddElements
import com.abcg.kotlinytmusicscraper.models.response.AccountMenuResponse
import com.abcg.kotlinytmusicscraper.models.response.AddItemYouTubePlaylistResponse
import com.abcg.kotlinytmusicscraper.models.response.BrowseResponse
import com.abcg.kotlinytmusicscraper.models.response.CreatePlaylistResponse
import com.abcg.kotlinytmusicscraper.models.response.DownloadProgress
import com.abcg.kotlinytmusicscraper.models.response.GetQueueResponse
import com.abcg.kotlinytmusicscraper.models.response.GetSearchSuggestionsResponse
import com.abcg.kotlinytmusicscraper.models.response.LikeStatus
import com.abcg.kotlinytmusicscraper.models.response.NextAndroidMusicResponse
import com.abcg.kotlinytmusicscraper.models.response.NextResponse
import com.abcg.kotlinytmusicscraper.models.response.PipedResponse
import com.abcg.kotlinytmusicscraper.models.response.PlayerResponse
import com.abcg.kotlinytmusicscraper.models.response.SearchResponse
import com.abcg.kotlinytmusicscraper.models.response.toLikeStatus
import com.abcg.kotlinytmusicscraper.models.simpmusic.FdroidResponse
import com.abcg.kotlinytmusicscraper.models.simpmusic.GithubResponse
import com.abcg.kotlinytmusicscraper.models.sponsorblock.SkipSegments
import com.abcg.kotlinytmusicscraper.models.youtube.GhostResponse
import com.abcg.kotlinytmusicscraper.models.youtube.Transcript
import com.abcg.kotlinytmusicscraper.models.youtube.YouTubeInitialPage
import com.abcg.kotlinytmusicscraper.pages.AlbumPage
import com.abcg.kotlinytmusicscraper.pages.ArtistPage
import com.abcg.kotlinytmusicscraper.pages.ArtistSection
import com.abcg.kotlinytmusicscraper.pages.BrowseResult
import com.abcg.kotlinytmusicscraper.pages.ExplorePage
import com.abcg.kotlinytmusicscraper.pages.MoodAndGenres
import com.abcg.kotlinytmusicscraper.pages.NextPage
import com.abcg.kotlinytmusicscraper.pages.NextResult
import com.abcg.kotlinytmusicscraper.pages.PlaylistContinuationPage
import com.abcg.kotlinytmusicscraper.pages.PlaylistPage
import com.abcg.kotlinytmusicscraper.pages.RelatedPage
import com.abcg.kotlinytmusicscraper.pages.SearchPage
import com.abcg.kotlinytmusicscraper.pages.SearchResult
import com.abcg.kotlinytmusicscraper.pages.SearchSuggestionPage
import com.abcg.kotlinytmusicscraper.parser.fromPlaylistContinuationToTracks
import com.abcg.kotlinytmusicscraper.parser.fromPlaylistToTrack
import com.abcg.kotlinytmusicscraper.parser.fromPlaylistToTrackWithSetVideoId
import com.abcg.kotlinytmusicscraper.parser.getContinuePlaylistContinuation
import com.abcg.kotlinytmusicscraper.parser.getPlaylistContinuation
import com.abcg.kotlinytmusicscraper.parser.getReloadParams
import com.abcg.kotlinytmusicscraper.parser.getSuggestionSongItems
import com.abcg.kotlinytmusicscraper.parser.hasReloadParams
import com.abcg.kotlinytmusicscraper.utils.NewPipeDownloaderImpl
import com.abcg.kotlinytmusicscraper.utils.NewPipeUtils
import com.abcg.kotlinytmusicscraper.utils.poTokenUtils.NewPipePoTokenProviderImpl
import com.abcg.kotlinytmusicscraper.utils.poTokenUtils.PoTokenGenerator
 ...
 * This library is from [z-huang/InnerTune] and I just modified it to comply with VxMusic
 *
 * Here is the object that can create all request to YouTube Music and Spotify in VxMusic
...
class YouTube(
     ...
     * In VxMusic, I use this function to parsing Home, Playlist, Album data instead using [album], [playlist], [artist] function
                                ...
                                if (!videoProgress.first || !audioProgress.first) {
                                    ...
                                    val command =
                                        listOf(
                                            ...
                                            "1:a:0",
                                            "-shortest",
                                            "$filePath-VxMusic.mp4",
                                        ).joinToString(" ")

                                    if (FileSystem.SYSTEM.exists("$filePath-VxMusic.mp4".toPath())) {
                                        FileSystem.SYSTEM.delete("$filePath-VxMusic.mp4".toPath())
                                    }
