...
import com.abcg.music.common.SETTINGS_FILENAME
...
import com.abcg.music.data.model.browse.artist.ResultSong
import com.abcg.music.data.model.browse.artist.ResultVideo
...
import com.abcg.spotify.model.response.spotify.SpotifyLyricsResponse
...
fun Track.toSongItemForDownload(): SongItem =
    SongItem(
        ...
        artists =
            this.artists?.map {
                com.abcg.kotlinytmusicscraper.models.Artist(
                    id = it.id ?: "",
                    name = it.name,
                )
            } ?: emptyList(),
        album =
            com.abcg.kotlinytmusicscraper.models.Album(
                id = this.album?.id ?: "",
