...
object MEDIA_NOTIFICATION {
    ...
    const val NOTIFICATION_CHANNEL_NAME = "VxMusic Playback Notification"
    const val NOTIFICATION_CHANNEL_ID = "VxMusic Playback Notification ID"
}
