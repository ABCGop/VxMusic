...
import com.abcg.kotlinytmusicscraper.models.SectionListRenderer
...
fun Thumbnail.toThumbnail(): com.abcg.music.data.model.searchResult.songs.Thumbnail =
    com.abcg.music.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<com.abcg.music.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<com.abcg.music.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
