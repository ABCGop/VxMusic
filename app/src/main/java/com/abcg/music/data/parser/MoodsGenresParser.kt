...
import com.abcg.music.data.model.explore.mood.genre.ItemsSong
import com.abcg.music.data.model.explore.mood.genre.Title
        ...
        if (items != null) {
            for (item in items) {
                if (item.musicCarouselShelfRenderer != null) {
                    ...
                    val listContent: MutableList<com.abcg.music.data.model.explore.mood.genre.Content> = mutableListOf()
                    if (!contents.isNullOrEmpty()) {
                        for (content in contents) {
                            if (content.musicResponsiveListItemRenderer != null) {
                                // Song
                                ...
                                val playlistBrowseId =
                                    content.musicTwoRowItemRenderer
                                        ...
                                        ?.browseId
                                listContent.add(
                                    com.abcg.music.data.model.explore.mood.genre.Content(
                                        playlistBrowseId = playlistBrowseId ?: "",
