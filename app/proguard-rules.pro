...
# Supabase - keep everything, don't let R8 touch it
-keep class io.github.jan.supabase.** { *; }
-keep interface io.github.jan.supabase.** { *; }
-keep enum io.github.jan.supabase.** { *; }
-keepclassmembers class io.github.jan.supabase.** {
    *;
}
-dontwarn io.github.jan.supabase.**

# Keep ALL Ktor classes - don't let R8 remove anything
-keep class io.ktor.** { *; }
...
# Specifically keep Ktor plugins that Supabase needs
...
-keep interface io.ktor.client.engine.** { *; }

# Don't warn about Ktor
-dontwarn io.ktor.**

# Keep ManagementFactory for Ktor debug detection (optional, can be safely dontwarn)
-dontwarn java.lang.management.ManagementFactory
-dontwarn java.lang.management.RuntimeMXBean

# Keep Supabase model classes for serialization
-keep class com.abcg.music.data.supabase.model.** { *; }
-keepclassmembers class com.abcg.music.data.supabase.model.** {
    <fields>;
    <methods>;
}

# Keep Supabase repository and client
-keep class com.abcg.music.data.supabase.** { *; }
-keep class com.abcg.music.data.supabase.repository.** { *; }
-keep class com.abcg.music.data.supabase.crypto.** { *; }

# Keep social navigation destinations
-keep class com.abcg.music.ui.navigation.destination.social.** { *; }

# Keep SocialViewModel and SocialRepository for Koin injection
-keep class com.abcg.music.viewModel.SocialViewModel { *; }
-keep class com.abcg.music.data.supabase.repository.SocialRepository { *; }
-keep class com.abcg.music.data.supabase.SupabaseClient { *; }

# Ktor Android engine
-dontwarn io.ktor.client.engine.android.**
-keep class io.ktor.client.engine.android.** { *; }

# PostgreSQL client warnings
-dontwarn io.github.jan.supabase.postgrest.**
-dontwarn io.github.jan.supabase.realtime.**
-dontwarn io.github.jan.supabase.storage.**

# Kotlinx serialization for Supabase
-keepclassmembers @kotlinx.serialization.Serializable class com.abcg.music.data.supabase.model.** {
    <fields>;
    <methods>;
}
...
# Keep Domain Repositories to prevent Koin definition loss
-keep class com.maxrave.domain.repository.** { *; }
-keep interface com.maxrave.domain.repository.** { *; }

# Keep App ViewModels
-keep class com.abcg.music.viewModel.** { *; }
-keep class com.abcg.music.sdui.** { *; }