...
android {
    ...
    defaultConfig {
        ...
        // Configure 16KB page size for better performance on newer Android devices
        externalNativeBuild {
            cmake {
                arguments += listOf(
...
sentry {
    ...
    authToken.set(token ?: "")
    includeProguardMapping.set(false) // Disabled for build
...
dependencies {
    ...
    // SDP/SSP - Scalable Dimension/Text Libraries
