package com.abcg.music.service.backup
...
class AutoBackupWorker(
    ...
    override suspend fun doWork(): Result = withContext(Dispatchers.IO) {
        try {
            ...
            // Save to Downloads/VxMusic folder
        ...
        return try {
            val contentValues = ContentValues().apply {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    put(MediaStore.Downloads.RELATIVE_PATH, "Download/VxMusic")
                }
            }
            ...
            uri?.let { outputUri ->
                ...
                Logger.i(TAG, "Backup saved to Downloads/VxMusic/$fileName")
                true
            } ?: false
        } catch (e: Exception) {
    ...
    private fun cleanupOldBackups(maxFiles: Int) {
        try {
            ...
            val selectionArgs = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                arrayOf("Download/VxMusic/", "simpmusic_backup_%.zip")
            } else {
